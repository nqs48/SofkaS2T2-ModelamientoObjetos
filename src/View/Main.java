...
import Model.Exc4.ControlSystem;
import Model.Exc4.Ferry;
import Model.Exc4.MenuExc4;
import Model.Exc4.Vehicle;
...
public class Main {
    public static void main(String[] args) {
        ...
        int userPreload,userMain, userMainE1, userCreate,userView,userMainE2,userMainE3,userMainE4;
        int autogeneratedID;
        do{
                        ...
                        switch (userMainE4) {
                            ...
                            case 3 -> {
                                ...
                                if (controlSystem.getFerries().size() == 0) {
                                    ...
                                    System.out.println("\n\n+The ferry's capacity is : "+ferry.getVehicles().size()+"/"+ ferry.getCapacity()+ " vehicles");
                                }
